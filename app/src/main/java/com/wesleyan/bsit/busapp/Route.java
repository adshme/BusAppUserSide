...
public class Route extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void SanJoseCubao(){
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(ter3));
        ...
        zoom = new LatLng(15.199310,120.957612);

        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(zoom, (float) 9.3));
    }
    ...
    public  void Cabanatuan(){
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLng(ter2));
        ...
        Polyline line = mMap.addPolyline(new PolylineOptions()
                .add(new LatLng(15.472456,120.968493),
                        ...
                        new LatLng(15.467524,120.962084),
                        new LatLng(15.467572,120.961705),
                        new LatLng(15.467813,120.961140),
                        new LatLng(15.470389,120.955475),
                        new LatLng(15.444309,120.943309),
                        new LatLng(15.430717,120.938867),
                        new LatLng(15.425054,120.938355),
                        new LatLng(15.425216,120.929948),
                        ...
                        new LatLng(15.484558,120.679810),
                        new LatLng(15.484986,120.679290),
                        new LatLng(15.485809,120.677968),
                        new LatLng(15.488343,120.673793),
                        new LatLng(15.488646,120.673764),
                        new LatLng(15.488957,120.673776),
                        new LatLng(15.489731,120.675460),
                        new LatLng(15.489853,120.675728),
                        new LatLng(15.489901,120.676368),
                        new LatLng(15.489739,120.676801),
                        new LatLng(15.489174,120.677435),
                        new LatLng(15.488899,120.677578),
                        new LatLng(15.482771,120.678167),
                        new LatLng(15.474798,120.677758),
                        new LatLng(15.474798,120.677758),
    ...
    private void offlineMODE(){
        final AlertDialog alertDialog = new AlertDialog.Builder(Route.this).create();
